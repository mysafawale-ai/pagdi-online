...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/dulha-sehra-in-pagdi-online",
    type: "website",
  },
}
...
export default function DulhaSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Expert sehra specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp"],
