...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/groom-pagdi-in-pagdi-online",
    type: "website",
  },
}
...
export default function GroomPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Expert pagdi specialists with 40+ years experience in India"],
