...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/turban-in-pagdi-online",
    type: "website",
  },
}
...
export default function TurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Expert turban specialists with 40+ years experience in India"],
