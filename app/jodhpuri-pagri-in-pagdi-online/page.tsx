...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/jodhpuri-pagri-in-pagdi-online",
    type: "website",
  },
}
...
export default function JodhpuriPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Expert pagri specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics"],
