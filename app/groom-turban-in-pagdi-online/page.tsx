...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/groom-turban-in-pagdi-online",
    type: "website",
  },
}
...
export default function GroomTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Expert turban specialists with 40+ years experience in India", "On-site professional service at your India venue"],
