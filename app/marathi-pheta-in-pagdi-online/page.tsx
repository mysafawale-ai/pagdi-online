...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/marathi-pheta-in-pagdi-online",
    type: "website",
  },
}
...
export default function MarathiPhetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations"],
