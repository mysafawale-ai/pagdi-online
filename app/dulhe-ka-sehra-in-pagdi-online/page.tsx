...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/dulhe-ka-sehra-in-pagdi-online",
    type: "website",
  },
}
...
export default function DulheKaSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in India", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India"],
