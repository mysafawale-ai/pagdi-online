...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/pagdi-for-marriage-in-pagdi-online",
    type: "website",
  },
}
...
export default function PagdiForMarriageInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp"],
