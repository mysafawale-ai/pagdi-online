...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/pagdi-for-groom-in-pagdi-online",
    type: "website",
  },
}
...
export default function PagdiForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp"],
