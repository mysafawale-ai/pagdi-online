...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/wedding-safa-for-rent-in-pagdi-online",
    type: "website",
  },
}
...
export default function WeddingSafaForRentInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics"],
