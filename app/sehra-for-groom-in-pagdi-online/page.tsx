...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/sehra-for-groom-in-pagdi-online",
    type: "website",
  },
}
...
export default function SehraForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India", "Expert sehra specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
