...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/dulha-pagri-in-pagdi-online",
    type: "website",
  },
}
...
export default function DulhaPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Expert pagri specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders"],
