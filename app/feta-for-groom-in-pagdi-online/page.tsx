...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/feta-for-groom-in-pagdi-online",
    type: "website",
  },
}
...
export default function FetaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders"],
