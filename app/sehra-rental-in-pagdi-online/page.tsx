...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/sehra-rental-in-pagdi-online",
    type: "website",
  },
}
...
export default function SehraRentalInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit"],
