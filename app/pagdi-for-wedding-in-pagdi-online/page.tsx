...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/pagdi-for-wedding-in-pagdi-online",
    type: "website",
  },
}
...
export default function PagdiForWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in India"],
