...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/jodhpuri-safa-for-groom-in-pagdi-online",
    type: "website",
  },
}
...
export default function JodhpuriSafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
