...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/designer-wedding-turban-in-pagdi-online",
    type: "website",
  },
}
...
export default function DesignerWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert turban specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp"],
