...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/groom-turban-shop-in-pagdi-online",
    type: "website",
  },
}
...
export default function GroomTurbanShopInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Expert turban specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Complete barati packages with matching coordination"],
