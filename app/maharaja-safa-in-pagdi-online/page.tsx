...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/maharaja-safa-in-pagdi-online",
    type: "website",
  },
}
...
export default function MaharajaSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day"],
