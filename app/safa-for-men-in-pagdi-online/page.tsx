...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdi.online/safa-for-men-in-pagdi-online",
    type: "website",
  },
}
...
export default function SafaForMenInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "On-site professional service at your India venue"],
